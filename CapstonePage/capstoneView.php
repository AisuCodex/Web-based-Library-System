...
$totalRecordsSql = "SELECT COUNT(*) as total FROM capstonebooks";
if ($search !== '') {
  ...
  <div class="allContainer">
    <div class="navbar">
      ...
      <div class="nav-links">
        ...
        <a class="ai-anchor-side" href="../codex-ai/hagai.php" onclick="showLoadingScreen()">  
...
<?php endif; ?>
    ...
    <table>
        ...
        <tr>
            ...
            <td><span>Control Number</span> <?php echo htmlspecialchars($row['control_number'], ENT_QUOTES, 'UTF-8'); ?></td>
            ...
            <td>
                ...
                <div class="button-group">
                    <button class="show-abstract-btn" onclick="toggleAbstract(<?php echo $row['id']; ?>, 'capstone')">SHOW CAPSTONE ABSTRACT</button>
                    <button class="reserve-btn" onclick="reserveBook(<?php echo $row['id']; ?>)">RESERVE</button>
                </div>
            </td>
...
<footer class="footer">
    ...
    <div id="reservation-confirm-modal" class="modal">
        <div class="modal-content">
            ...
            <p id="reservation-confirm-text">Are you sure you want to reserve this book?</p>
    ...
    <script src="../JavaScripts/reserveBook.js"></script>
